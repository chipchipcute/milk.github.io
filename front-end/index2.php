...
<div class="container">
  <div class="row">     
    ...
    <section class="right-content col-lg-9 col-xs-12  collection float-right">
            ...
            <h1 class="title-head" style="margin-top: 25px;">Sản Phẩm Theo Danh Mục: <?php echo $cate['name'] ?><span style="
            ...
            justify-content: center;
             align-items: center; 
             "><?php echo (mysqli_num_rows($product)) ?></span></h1>
                ...
                <div class="product-box">                 
                    <div class="product-thumbnail">
                      <a href="" title="Tên sản phẩm">
                        ...
                        <div class="front">                        
                         <img src="../uploads/<?php echo $data['image'] ?>" alt="" style ="max-height: 300px">
                      </div>
                      <div class="back">
                        <img src="../uploads/<?php echo $data['image'] ?>" alt="" style ="max-height: 300px">
                      </div>
                    ...
                    <div class="product-info">
                      <h3 class="product-name"><a href="index3.php?sanpham=<?php echo $data['id'] ?>"><?php echo $data['name'] ?></a></h3>
                      
                      
                      <div class="product-price"><?php echo number_format($data['price']) ?>đ</div>
                      <div class="product-price" style="position: absolute; left: 9px;top: 37px; color: BurlyWood  " >Trọng lượng:<a style="padding-left: 20px;color: BurlyWood;"><?php echo $data['weight'] ?>gr</a>  
                      </div>
                      </div>
 ...
 <div class="menu-trai" style="height: 600px">
        <div class="menu-tieude">
           <?php foreach ($category as $key => $value): ?> 
            <h2 style="font-family: arial;"><?php echo $value['name']?>:Sản phẩm</h2>
            <?php endforeach ?>
            <ul><li>
                <?php foreach ($product as $key => $value): ?> 
                  <a href=" index3.php?sanpham=<?php echo $value['id'] ?>  "><?php echo $value['name'] ?></a>
                <?php endforeach ?>
              </li>
            </ul>
        </div>
...
<!-- footer -->
<footer class="footer-v1" style="background: SeaGreen;width: 1517px;margin-left: -190px;margin-top: 150px">
...
<p><span style="color: #ffffff;"><span style="font-size: medium;"><span style="font-size: small;"><span style="color: #ffffff;">Email: tranhiep010201@gmail.com</span></span></span></span></p>
  ...
  <div style="display: none;left: 70%;margin-left: -309px;z-index: 1002;position: fixed;top: 40%;margin-top: 0px;" id="loadding"><img src="template/img/loader.gif" />
  </div>
</body>
</html>
